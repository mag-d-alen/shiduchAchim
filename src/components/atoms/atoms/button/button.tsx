...
const button = cva(
  'rounded-full items-center font-medium border box-border flex gap-x-2 outline-none transition-colors rtl:font-afek disabled:cursor-not-allowed cursor-pointer',
  {
    variants: {
      intent: {
        primary:
