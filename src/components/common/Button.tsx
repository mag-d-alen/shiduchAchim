...
const button = cva({
  base: 'flex items-center justify-center font-medium  gap-x-2 outline-none disabled:cursor-not-allowed h-10 cursor-pointer transition-all duration-400 ease-out text-lg align-top rounded-full shadow-md w-40',
  variants: {
    intent: {
      primary:
