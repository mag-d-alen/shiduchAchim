...
export const CustomSelect = ({ setSelected, placeholder, options, withIcon=true }: { setSelected: (value: string) => void,  withIcon? : boolean, placeholder?: string, options: { value: any, label: string }[] }) => {
    const styles = {
    ...
    return (
        <div>
            <Select components={ withIcon ? { DropdownIndicator }:{}}
